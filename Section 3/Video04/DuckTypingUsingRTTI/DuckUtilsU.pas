...
uses MainFormU, System.Generics.Collections, System.SysUtils, System.Classes, System.Rtti;

type
  Duck = class sealed
    class procedure Apply(ArrayOf: TArray<TObject>; PropName: string; PropValue: TValue;
      AcceptFunction: TFunc<TObject, boolean> = nil); overload;
    class procedure Apply(AContainer: TComponent; PropName: string; PropValue: TValue;
      AcceptFunction: TFunc<TObject, boolean> = nil); overload;
  end;

implementation

class procedure Duck.Apply(ArrayOf: TArray<TObject>; PropName: string; PropValue: TValue;
...
class procedure Duck.Apply(AContainer: TComponent; PropName: string; PropValue: TValue;
  AcceptFunction: TFunc<TObject, boolean>);
var
  Item: TComponent;
  List: TList<TObject>;
