...
type
  TMainForm = class(TForm)
    ...
    ListBox1: TListBox;
    procedure Edit3KeyUp(Sender: TObject; var Key: Word; var KeyChar: Char; Shift: TShiftState);
  private
...
procedure TMainForm.Edit3KeyUp(Sender: TObject; var Key: Word; var KeyChar: Char; Shift: TShiftState);
begin
