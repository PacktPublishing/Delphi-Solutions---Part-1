...
uses
  ...
  FMX.Types, FMX.Graphics, FMX.Controls, FMX.Forms, FMX.Dialogs, FMX.StdCtrls, System.Rtti, Data.Bind.GenData,
  Data.Bind.EngExt, FMX.Bind.DBEngExt, FMX.Bind.Grid, System.Bindings.Outputs, FMX.Bind.Editors, Data.Bind.Components,
  Data.Bind.Grid, Data.Bind.ObjectScope, FMX.Layouts, FMX.Grid, BusinessObjectsU, System.Generics.Collections,
  FMX.Bind.GenData, FMX.ListView.Types, FMX.ListView, FMX.Bind.Navigator, FMX.Edit, FMX.ListBox,
...
type
  TMainForm = class(TForm)
    ...
    procedure bsPeopleCreateAdapter(Sender: TObject; var ABindSourceAdapter: TBindSourceAdapter);
    procedure FormCreate(Sender: TObject);
    procedure bsEmailsCreateAdapter(Sender: TObject; var ABindSourceAdapter: TBindSourceAdapter);
...
procedure TMainForm.bnEmailsBeforeAction(Sender: TObject; Button: TNavigateButton);
var
  email: string;
begin
...
procedure TMainForm.bsPeopleCreateAdapter(Sender: TObject; var ABindSourceAdapter: TBindSourceAdapter);
begin
...
begin
  bsEmailsAdapter.SetList(bsPeopleAdapter.List[bsPeopleAdapter.CurrentIndex].Emails, False);
