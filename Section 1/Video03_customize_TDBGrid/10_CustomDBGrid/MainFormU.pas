...
procedure TMainForm.DBGrid1DrawColumnCell(Sender: TObject; const Rect: TRect; DataCol: Integer;
  Column: TColumn; State: TGridDrawState);
var
  LRect: TRect;
  LGrid: TDBGrid;
...
begin
  ...
  begin
    ...
    begin
      ...
      LGrid.Canvas.TextOut(LRect.Left + ((LRect.Width div 2) - (LTextWidth.cx div 2)),
        LRect.Top + ((LRect.Height div 2) - (LTextWidth.cy div 2)), LText);
    end
    ...
    begin
      ...
      begin
        ...
        DrawCheck(LGrid.Canvas, TPoint.Create(LRect.Left, LRect.Top + LRect.Height div 2),
          LRect.Height div 3);
      end;
    end
    ...
    begin
      ...
      LGrid.Canvas.FillRect(LRect);
      Inc(LRect.Left);
      ImageList1.Draw(LGrid.Canvas, LRect.CenterPoint.X - (ImageList1.Width div 2),
        LRect.CenterPoint.Y - (ImageList1.Height div 2), Trunc(LRating) * 2);
    end;
  end
  else
